...
private:
  ...
  G4VSolid*          fSolidScreen;
  G4LogicalVolume*   fLogicScreen;
  G4VPhysicalVolume* fPhysiScreen;
  
  G4VSolid*          fSolidScreenSource;
  G4LogicalVolume*   fLogicScreenSource;
  G4VPhysicalVolume* fPhysiScreenSource;
  
  G4VSolid*          fSolidScreenBeforePP;
  G4LogicalVolume*   fLogicScreenBeforePP;
  G4VPhysicalVolume* fPhysiScreenBeforePP;
  
  G4VSolid*          fSolidScreenAfterPP;
  G4LogicalVolume*   fLogicScreenAfterPP;
  G4VPhysicalVolume* fPhysiScreenAfterPP;

  G4Box*             fSolidMagnet;
  G4LogicalVolume*   fLogicMagnet;
  G4VPhysicalVolume* fPhysiMagnet;
  G4FieldManager*    fMagnetFieldMgr;
